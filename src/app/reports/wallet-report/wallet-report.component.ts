...
export class WalletReportComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.authService.getWalletReport(object).subscribe(
      (res: any) => {
        ...
        this.dataSource = new MatTableDataSource(this.getReports);
  ...
  startEvent(event) {
    ...
    // const object = { startDate: this.startDate, endDate: this.endDate }
  ...
  exportIt() {
    ...
    this.exporter.exportTable(ExportType.XLSX, {
      fileName: `Wallet Report ${this.formattedDateTime}`,
    });
  }
