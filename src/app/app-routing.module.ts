  ...
  { path: '', loadChildren: () => import('./login/login.module').then((m) => m.AuthModule) },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./products/poultry-product/poultry-product.module').then((m) => m.PoultryProductModule),
      },
      {
        path: 'poultry_related_products/:id',
        loadChildren: () =>
          import('./products/poultry-related/poultry-related.module').then((m) => m.PoultryRelatedModule),
      },
      {
        path: 'feeding_products',
        loadChildren: () =>
          import('./products/feeding-product/feeding-product.module').then((m) => m.FeedingProductModule),
      },
      {
        path: 'feeding_related_products/:id',
        loadChildren: () =>
          import('./products/feeding-related/feeding-related.module').then((m) => m.FeedingRelatedModule),
      },
      {
        path: 'recepies',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./pricelist/product-assign/product-assign.module').then((m) => m.ProductAssignModule),
      },
      {
        path: 'assign_price',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./orders/delivery-orders/delivery-orders.module').then((m) => m.DeliveryOrdersModule),
      },
      {
        path: 'pickup_orders',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./orders/completed-orders/completed-orders.module').then((m) => m.CompletedOrdersModule),
      },
      {
        path: 'cancelled_orders',
        loadChildren: () =>
          import('./orders/canelled-orders/canelled-orders.module').then((m) => m.CanelledOrdersModule),
      },
      {
        path: 'normal_coupons',
      ...
      },
      {
        path: 'settings',
        loadChildren: () =>
          import('./settings/master-setting/master-setting.module').then((m) => m.MasterSettingModule),
      },
      {
        path: 'one-day-orders',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./reports/salesman-report/salesman-report.module').then((m) => m.SalesmanReportModule),
      },
      {
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./reports/employee-purchase/employee-purchase.module').then((m) => m.EmployeePurchaseModule),
      },
      {
        path: 'most-wanted-products',
        loadChildren: () =>
          import('./reports/most-wanted-products/most-wanted-products.module').then((m) => m.MostWantedProductsModule),
      },
      {
        path: 'most-wanted-address',
        loadChildren: () =>
          import('./reports/most-wanted-address/most-wanted-address.module').then((m) => m.MostWantedAddressModule),
      },
      {
        path: 'favorite-products',
        loadChildren: () =>
          import('./reports/favourit-products/favourit-products.module').then((m) => m.FavouritProductsModule),
      },
      {
        path: 'accepted-orders-reports',
        loadChildren: () =>
          import('./reports/accepted-orders/accepted-orders.module').then((m) => m.AcceptedOrdersModule),
      },
      {
        path: 'lucky-draw',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./settings/spin-wheel-slices/spin-wheel-slices.module').then((m) => m.SpinWheelSlicesModule),
      },
      {
        path: 'spin-winner',
        loadChildren: () =>
          import('./settings/spin-wheel-winner/spin-wheel-winner.module').then((m) => m.SpinWheelWinnerModule),
      },
      {
        path: 'content_editor',
