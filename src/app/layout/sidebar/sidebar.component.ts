    ...
    this.menuItems = [
      ...
      } : false,
      {
        ...
        subItems: [
          ...
          (this.isSuperAdmin || (!this.isSuperAdmin && datat?.find(ele => ele.area == 'internal-sales-reports')?.read == 1)) ?
            {
          ...
          (this.isSuperAdmin || (!this.isSuperAdmin && datat?.find(ele => ele.area == 'most-wanted-product-reports')?.read == 1)) ?
            {
              label: 'Most Wanted Product Reports',
              link: '/most-wanted-products',
            } : false,
          (this.isSuperAdmin || (!this.isSuperAdmin && datat?.find(ele => ele.area == 'most-wanted-address-reports')?.read == 1)) ?
            {
