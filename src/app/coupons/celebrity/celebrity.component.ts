...
export class CelebrityComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.authService.getCoupon('CELIBRITY').subscribe((res: any) => {
  ...
  onSubmitData() {
    ...
    this.submitted = false;
    this.couponForm.value.type = 'CELIBRITY';
