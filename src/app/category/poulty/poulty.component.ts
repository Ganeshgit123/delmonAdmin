...
export class PoultyComponent implements OnInit {
  ...
  onSubmitData() {
    ...
    this.authService.s3upload(postData).subscribe((res: any) => {
      if (res.error == false) {
        ...
        this.authService.addPoultryCategory(data)
          .subscribe((res: any) => {
            if (res.error == false) {
    ...
    if (this.fileImgUpload) {
      ...
      this.authService.s3upload(postData).subscribe((res: any) => {
        if (res.error == false) {
          ...
          this.authService.editCategory(data, this.categoryId)
            .subscribe((res: any) => {
              if (res.error == false) {
                this.toastr.success('Success ', res.message);
                this.iconImg = null;
  ...
  changeStatus(value) {
    ...
    this.authService.editCategory(object, value.id)
      .subscribe((res: any) => {
        if (res.error == false) {
          this.toastr.success('Success ', res.message);
          this.ngOnInit();
