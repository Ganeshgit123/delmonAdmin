...
export class PinComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, public fb: FormBuilder, public authService: AuthService,
    ...
    ngOnInit(): void {
      ...
      this.authService.getPin(this.areaId).subscribe(
        (res: any) => {
    ...
    this.pinForm.value.areaId = this.areaId;
      ...
      this.authService.addPin(this.pinForm.value)
        .subscribe((res: any) => {
          if (res.error == false) {
    ...
    pinEditService(data) {
      this.authService.editPin(data, this.pinId)
        .subscribe((res: any) => {
          if (res.error == false) {
            this.toastr.success('Success ', res.message);
            this.pinForm.reset();
    ...
    changeStatus(value) {
      ...
      this.authService.editPin(object, value.id)
        .subscribe((res: any) => {
          if (res.error == false) {
            this.toastr.success('Success ', res.message);
            this.ngOnInit();
